    ...
    <div className="bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-white pt-14">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 text-center animate-fade-in py-20">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link 
              href="/blog" 
              className="px-12 py-4 bg-xiaomi-orange text-white text-base font-medium hover:bg-xiaomi-orange-hover hover:shadow-2xl transition-all duration-200 shadow-lg"
            >
              探索博客
            </Link>
            <Link 
              href="/about" 
              className="px-12 py-4 bg-white text-xiaomi-text text-base font-medium border border-gray-300 hover:border-gray-800 transition-all duration-200"
            >
              关于我
            </Link>
          </div>
      ...
      <section className="py-40 bg-xiaomi-dark text-white">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 text-center">
          ...
          <Link 
            href="/contact" 
            className="inline-block px-16 py-5 bg-xiaomi-orange text-white hover:bg-xiaomi-orange-hover hover:shadow-2xl transition-all duration-200 font-medium text-base"
          >
            联系我
          </Link>
        </div>
