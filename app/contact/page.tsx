    ...
    <div className="min-h-screen bg-white pt-14 pb-32">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Contact Form */}
          <div className="bg-gray-50 p-12 animate-slide-up">
            <h2 className="text-3xl font-black text-xiaomi-text mb-8 tracking-tight">发送消息</h2>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-sm font-bold text-xiaomi-text mb-2">
                  姓名
                </label>
                <input
                  type="text"
                  ...
                  required
                  className="w-full px-4 py-3 border-2 border-gray-300 focus:border-xiaomi-orange outline-none transition-all"
                  placeholder="你的姓名"
                />
              </div>

              <div>
                <label htmlFor="email" className="block text-sm font-bold text-xiaomi-text mb-2">
                  邮箱
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-bold text-xiaomi-text mb-2">
                  消息
                </label>
                <textarea
                  id="message"
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 border-2 border-gray-300 focus:border-xiaomi-orange outline-none transition-all resize-none"
                  placeholder="告诉我你的想法..."
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full px-8 py-4 bg-xiaomi-orange text-white hover:bg-xiaomi-orange-hover hover:shadow-2xl transition-all duration-200 font-medium text-base"
              >
                发送消息
              </button>
            </form>
